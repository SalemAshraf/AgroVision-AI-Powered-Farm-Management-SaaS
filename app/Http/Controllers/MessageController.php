    ...
    return response()->json([
        'latest_conversations' => $messages->map(function ($message) {
            ...
            return [
                ...
                'sender_name' => $message->sender->name ?? null,
                'sender_image' => $senderImage ? 'https://final.agrovision.ltd/storage/app/public/' . $senderImage : null,
                'receiver_name' => $message->receiver->name ?? null,
                'receiver_image' => $receiverImage ? 'https://final.agrovision.ltd/storage/app/public/' . $receiverImage : null,
